        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 xl:mr-12">
              ...
              >
                <Image
                  src="/images/logo/logo-ventureos.png"
                  alt="Venture OS"
                  width={140}
                  height={30}
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                <Link
                  href="#"
                  className="sp_popup_9393a0b7-856e-44ee-8169-f24bfe4d5e7f ease-in-up hidden rounded-md bg-primary py-3 px-8 text-base font-bold text-white transition duration-300 hover:bg-opacity-90 hover:shadow-signUp md:block md:px-9 lg:px-6 xl:px-9">
                  Get Beta Access
                </Link>
                <div>
                  <ThemeToggler />
